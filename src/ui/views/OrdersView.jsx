...
import { formatCurrency, formatDate, formatPhonePair } from '@/utils/formatters'
...
function OrdersView() {
  ...
  const rows = useMemo(() => applyOrderFilters(orders, search, status), [orders, search, status])
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <FilterBar
        ...
        subtitle="متابعة كشوفات جميع الفواتير، تحديث الحالات، المرتجعات وتتبع الديون"
        actions={
