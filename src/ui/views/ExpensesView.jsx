    ...
    <tr>
      ...
      <td>
        <div className="flex items-center gap-1">
          ...
          <Button size="sm" variant="ghost" icon={Trash2} onClick={remove} className="text-rose-400 hover:bg-rose-950/40 hover:text-rose-300">
            حذف
          </Button>
        </div>
      </td>
...
function ExpensesView() {
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4 bg-slate-900/70 p-6 rounded-2xl border border-slate-800">
        <div>
